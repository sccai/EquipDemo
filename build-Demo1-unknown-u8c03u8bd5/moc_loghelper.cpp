...
#include "../Demo1/tool/loghelper.h"
...
const QMetaObject LogHelper::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_LogHelper.data,
      qt_meta_data_LogHelper,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *LogHelper::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LogHelper.stringdata0))
        return static_cast<void*>(const_cast< LogHelper*>(this));
