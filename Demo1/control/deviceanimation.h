#ifndef DEVICEANIMATION_H
#define DEVICEANIMATION_H
...
class QDESIGNER_WIDGET_EXPORT DeviceAnimation : public QWidget
        #else
class DeviceAnimation : public QWidget
        #endif
...
public:
    explicit DeviceAnimation(QWidget *parent = 0);
...
public Q_SLOTS:
    ...
    void setBgPixmap();
    //设置是否显示图片切换
    void setShowPixmap(bool showPixmap);

    //设置背景色
    void setStatusImageColor(const QPixmap &img1,const QPixmap &img2,const QPixmap &img3,const QPixmap &img4);
    void startAlarmNew();
    void alarmNew();
};

#endif // DEVICEANIMATION_H
